...
const Login = () => {
  ...
  return (
   <main className='container mx-auto mt- md:mt-15 p-5 md:flex md:justify-center'>
   ...
   <h1 className="inline bg-gradient-to-r from-emerald-300 via-emerald-700 to-emerald-300 bg-clip-text font-display text-5xl tracking-tight text-transparent">
      ...
      <h2
      className="bg-gradient-to-r from-emerald-300 via-emerald-700 to-emerald-300 bg-clip-text font-display text-5xl tracking-tight text-transparent">
            Iniciar sesión 
      </h2>
    <form 
      onSubmit={onSubmit}
